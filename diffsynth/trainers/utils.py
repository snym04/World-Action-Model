...
def launch_training_task(
    ...
    dataloader = torch.utils.data.DataLoader(dataset, shuffle=True, batch_size=args.batch_size, collate_fn=lambda x: x[0], num_workers=num_workers)
...
def launch_data_process_task(
    ...
    dataloader = torch.utils.data.DataLoader(dataset, shuffle=False, batch_size=args.batch_size, collate_fn=lambda x: x[0], num_workers=num_workers)
    accelerator = Accelerator()
